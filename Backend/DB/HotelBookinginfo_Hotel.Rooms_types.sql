...
--
-- Table structure for table `Hotel.Rooms_types`
--

DROP TABLE IF EXISTS `Hotel.Rooms_types`;
...
--
-- Dumping data for table `Hotel.Rooms_types`
--

LOCK TABLES `Hotel.Rooms_types` WRITE;
/*!40000 ALTER TABLE `Hotel.Rooms_types` DISABLE KEYS */;
INSERT INTO `Hotel.Rooms_types` VALUES (1,'King',5,150),(2,'Queen',3,100),(3,'Standard',2,50);
/*!40000 ALTER TABLE `Hotel.Rooms_types` ENABLE KEYS */;
UNLOCK TABLES;

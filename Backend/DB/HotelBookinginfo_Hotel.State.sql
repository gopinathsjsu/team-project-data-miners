...
--
-- Table structure for table `Hotel.State`
--

DROP TABLE IF EXISTS `Hotel.State`;
...
--
-- Dumping data for table `Hotel.State`
--

LOCK TABLES `Hotel.State` WRITE;
/*!40000 ALTER TABLE `Hotel.State` DISABLE KEYS */;
INSERT INTO `Hotel.State` VALUES (1,'CA'),(2,'TELANGANA');
/*!40000 ALTER TABLE `Hotel.State` ENABLE KEYS */;
UNLOCK TABLES;

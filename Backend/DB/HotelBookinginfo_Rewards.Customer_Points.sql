...
--
-- Table structure for table `Rewards.Customer_Points`
--

DROP TABLE IF EXISTS `Rewards.Customer_Points`;
...
--
-- Dumping data for table `Rewards.Customer_Points`
--

LOCK TABLES `Rewards.Customer_Points` WRITE;
/*!40000 ALTER TABLE `Rewards.Customer_Points` DISABLE KEYS */;
/*!40000 ALTER TABLE `Rewards.Customer_Points` ENABLE KEYS */;
UNLOCK TABLES;

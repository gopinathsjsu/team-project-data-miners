...
--
-- Table structure for table `Booking.Reviews`
--

DROP TABLE IF EXISTS `Booking.Reviews`;
...
--
-- Dumping data for table `Booking.Reviews`
--

LOCK TABLES `Booking.Reviews` WRITE;
/*!40000 ALTER TABLE `Booking.Reviews` DISABLE KEYS */;
INSERT INTO `Booking.Reviews` VALUES (1,1,4,'Clean and good customer service');
/*!40000 ALTER TABLE `Booking.Reviews` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-09 11:34:06

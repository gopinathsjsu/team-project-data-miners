...
--
-- Table structure for table `Hotel.Location_info`
--

DROP TABLE IF EXISTS `Hotel.Location_info`;
...
--
-- Dumping data for table `Hotel.Location_info`
--

LOCK TABLES `Hotel.Location_info` WRITE;
/*!40000 ALTER TABLE `Hotel.Location_info` DISABLE KEYS */;
INSERT INTO `Hotel.Location_info` VALUES (1,'1 Washington Sq',1,1,1,95192),(2,'500 El Camino Real',1,1,2,95053),(3,'2100 Moorpark Ave',1,1,1,95128),(7,'test 12345',2,2,3,60001);
/*!40000 ALTER TABLE `Hotel.Location_info` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-09 11:34:08

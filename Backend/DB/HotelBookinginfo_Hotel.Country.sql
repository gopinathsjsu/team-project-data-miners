...
--
-- Table structure for table `Hotel.Country`
--

DROP TABLE IF EXISTS `Hotel.Country`;
...
--
-- Dumping data for table `Hotel.Country`
--

LOCK TABLES `Hotel.Country` WRITE;
/*!40000 ALTER TABLE `Hotel.Country` DISABLE KEYS */;
INSERT INTO `Hotel.Country` VALUES (1,'USA'),(2,'INDIA');
/*!40000 ALTER TABLE `Hotel.Country` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-09 11:34:12

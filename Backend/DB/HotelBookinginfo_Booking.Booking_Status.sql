...
--
-- Table structure for table `Booking.Booking_Status`
--

DROP TABLE IF EXISTS `Booking.Booking_Status`;
...
--
-- Dumping data for table `Booking.Booking_Status`
--

LOCK TABLES `Booking.Booking_Status` WRITE;
/*!40000 ALTER TABLE `Booking.Booking_Status` DISABLE KEYS */;
INSERT INTO `Booking.Booking_Status` VALUES (1,'Created'),(10,'Created');
/*!40000 ALTER TABLE `Booking.Booking_Status` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-09 11:34:02
